...
public class WebEntrance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = numbersList.get(pos).getVoucherUrl();;
        ...
        if(!name.equals(""))
        {
            ...
            m_webview.setWebViewClient(new WebEntrance.MyWebViewClient());
            ...
            Toast.makeText(WebEntrance.this,"No Document Available Now ", Toast.LENGTH_SHORT).show();
        }
        ...
        m_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    DownloadPDFfromURL();
                    Toast.makeText(WebEntrance.this, "Downloaded ", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(WebEntrance.this,"No Document Available Now ", Toast.LENGTH_SHORT).show();
                }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            Toast.makeText(WebEntrance.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void DownloadPDFfromURL(){
        ArrayList<FlightModel> numbersList = (ArrayList<FlightModel>) getIntent().getSerializableExtra("voucher");
        pos = getIntent().getIntExtra("position", 0);
        String name=numbersList.get(pos).getVoucherUrl();;

...
public class WebTransferIte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!name.equals(""))
        {
            ...
            m_webview.setWebViewClient(new WebTransferIte.MyWebViewClient());
            m_webview.requestFocus();
            m_webview.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url="+name);
        }
        else {
            Toast.makeText(WebTransferIte.this,"No Document Available Now ", Toast.LENGTH_SHORT).show();
        }
        ...
        m_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name.equals(""))
                {
                    ...
                    DownloadPDFfromURL();
                    Toast.makeText(WebTransferIte.this, "Downloaded ", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            Toast.makeText(WebTransferIte.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
        }
    }
